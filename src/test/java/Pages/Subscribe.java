...
public class Subscribe extends AbstractPage{
    ...
    public boolean isSubscribe(){
        ...
        if ((driver.findElement( By.className("success-msg")).getText().contains("Подписка сохранена."))
                ||(driver.findElement( By.className("success-msg")).getText().contains("Подписка удалена.")))
            sendMessageInIsTrue = true;
